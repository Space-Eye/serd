...
class  HousingRequest(models.Model):
    ...
    pet_number = models.PositiveSmallIntegerField(verbose_name=_("Anzahl der Haustiere"))
...
class Offer(models.Model):
    ...
    state = models.CharField(choices=OFFER_STATE, max_length=64, verbose_name=_("Status"))
