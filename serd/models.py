...
class  HousingRequest(models.Model):
    ...
    who = models.CharField(max_length=256, verbose_name=_("Bitte beschreiben Sie Ihre Gruppe kurz (Alter, Geschlecht, ...)"), blank=True)
    ...
    languages = MultiSelectField(choices=LANGUAGE_CHOICE, verbose_name=_("Sprachkenntnisse"), null=True)
    ...
    private_comment = models.CharField(blank=True, null=True, verbose_name=_("Interner Kommentar"), default="", max_length=150)
